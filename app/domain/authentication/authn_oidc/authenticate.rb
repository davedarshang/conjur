  ...
  module AuthnOidc
    Authenticate = CommandClass.new(
      ...
      def access_token(input)
        ...
        id_token_attributes = @decode_and_verify_id_token.(oidc_client_configuration.provider_uri, request_body.id_token)

        input = input.update(username: conjur_username(id_token_attributes, oidc_client_configuration.id_token_user_property))
